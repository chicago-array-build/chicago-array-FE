...
class Selectors extends React.Component {
  ...
  fetchData = event => {event.preventDefault(); this.props.fetchData(this.state)};

  getMeasures = name => {console.log(name)};
    ...
    return (
      <div className={classes.root}>
        <FormControl component="fieldset" className={classes.formControl}>
          <FormLabel component="legend">Select Measures for Data Visualization</FormLabel>
          <FormGroup>
            <FormControlLabel
              control={
        ...
        <FormControl required error={error} component="fieldset" className={classes.formControl}>
          ...
          <FormGroup>
            <FormControlLabel
              control={
                <Checkbox name={this.state.measure} onChange={this.handleChange('temp')} value="Temp" />
              }
